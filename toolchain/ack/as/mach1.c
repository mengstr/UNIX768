...
/* 07x */	0,
/* 070 */	DTA|MEM|CTR|ALT|FITW|PUTW | ((unsigned long)RELO2)<<8,
/* 071 */	DTA|MEM|CTR|ALT     |PUTL | ((unsigned long)RELO4)<<8,
/* 072 */	DTA|MEM|CTR    |FITW|PUTW | ((unsigned long)(RELO2|RELPC))<<8,
/* 073 */	DTA|MEM|CTR         |PUTW | ((unsigned long)(RELO1|RELPC))<<8,
/* 074x */	0,
/* 074B */	DTA|MEM        |FITB|PUTW | ((unsigned long)RELO1)<<8,
/* 074W */	DTA|MEM        |FITW|PUTW | ((unsigned long)RELO2)<<8,
/* 074L */	DTA|MEM             |PUTL | ((unsigned long)RELO4)<<8,
};
#endif
