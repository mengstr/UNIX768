...
/* allocation definitions of struct brace */
extern struct brace *h_brace;
#ifdef DEBUG
extern int cnt_brace;
extern char *std_alloc();
#define new_brace() ((struct brace *) std_alloc((char **)&h_brace, sizeof(struct brace), 10, &cnt_brace))
#else
#define	new_brace() ((struct brace *) st_alloc((char **)&h_brace, sizeof(struct brace), 10))
#endif
#define	free_brace(p) st_free(p, &h_brace, sizeof(struct brace))
