...
#define new_sdef() ((struct sdef *) std_alloc((char **)&h_sdef, sizeof(struct sdef), 50, &cnt_sdef))
#else
#define	new_sdef() ((struct sdef *) st_alloc((char **)&h_sdef, sizeof(struct sdef), 50))
#endif
#define	free_sdef(p) st_free(p, &h_sdef, sizeof(struct sdef))


struct tag
{ /* for struct-, union- and enum tags */
	struct tag* next;
	int tg_level;
...
extern int cnt_tag;
extern char *std_alloc();
#define new_tag() ((struct tag *) std_alloc((char **)&h_tag, sizeof(struct tag), 10, &cnt_tag))
#else
#define	new_tag() ((struct tag *) st_alloc((char **)&h_tag, sizeof(struct tag), 10))
#endif
