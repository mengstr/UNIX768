...
#define new_expr() ((struct expr *) std_alloc((char **)&h_expr, sizeof(struct expr), 20, &cnt_expr))
#else
#define	new_expr() ((struct expr *) st_alloc((char **)&h_expr, sizeof(struct expr), 20))
#endif
...
struct expr*
new_oper(struct type* tp, register struct expr* e1, int oper, register struct expr* e2);
