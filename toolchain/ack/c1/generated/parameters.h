...
#define ISTRSIZE	32	/* minimum number of bytes allocated for
					storing a string		*/
#ifdef ACK_TARGET_C1_SMALL_MEMORY
#define RSTRSIZE	8	/* smaller growth step on constrained hosts */
#else
...
#ifndef ACK_TARGET_C1_SMALL_MEMORY
...
#ifndef ACK_TARGET_C1_BUFFERED_INPUT
