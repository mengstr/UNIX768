...
extern struct type *schar_type, *uchar_type, *short_type, *ushort_type, *word_type, *uword_type,
    *int_type, *uint_type, *long_type, *ulong_type, *lnglng_type, *ulnglng_type, *float_type,
    *double_type, *lngdbl_type, *void_type, *string_type, *funint_type, *error_type;
...
#define new_type() ((struct type *) std_alloc((char **)&h_type, sizeof(struct type), 50, &cnt_type))
#else
#define	new_type() ((struct type *) st_alloc((char **)&h_type, sizeof(struct type), 50))
#endif
