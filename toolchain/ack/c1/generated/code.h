...
/* allocation definitions of struct string_cst */
extern struct string_cst *h_string_cst;
#ifdef DEBUG
extern int cnt_string_cst;
extern char *std_alloc();
#define new_string_cst() ((struct string_cst *) std_alloc((char **)&h_string_cst, sizeof(struct string_cst), 5, &cnt_string_cst))
#else
#define	new_string_cst() ((struct string_cst *) st_alloc((char **)&h_string_cst, sizeof(struct string_cst), 5))
#endif
#define	free_string_cst(p) st_free(p, &h_string_cst, sizeof(struct string_cst))
...
void code_declaration(register struct idf* idf, struct expr* expr, int lvl, int sc);
