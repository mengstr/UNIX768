...
/* allocation definitions of struct proto */
extern struct proto *h_proto;
#ifdef DEBUG
extern int cnt_proto;
extern char *std_alloc();
#define new_proto() ((struct proto *) std_alloc((char **)&h_proto, sizeof(struct proto), 20, &cnt_proto))
#else
#define	new_proto() ((struct proto *) st_alloc((char **)&h_proto, sizeof(struct proto), 20))
#endif
#define	free_proto(p) st_free(p, &h_proto, sizeof(struct proto))
