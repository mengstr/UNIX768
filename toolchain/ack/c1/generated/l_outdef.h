...
/* allocation definitions of struct argument */
extern struct argument *h_argument;
#ifdef DEBUG
extern int cnt_argument;
extern char *std_alloc();
#define new_argument() ((struct argument *) std_alloc((char **)&h_argument, sizeof(struct argument), 10, &cnt_argument))
#else
#define	new_argument() ((struct argument *) st_alloc((char **)&h_argument, sizeof(struct argument), 10))
#endif
#define	free_argument(p) st_free(p, &h_argument, sizeof(struct argument))
