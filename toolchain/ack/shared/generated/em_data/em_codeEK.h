...
void CC_bhdnam(int, arith, char *, arith, int);
void CC_bhfcon(int, arith, char *, arith, int);
void CC_bhicon(int, arith, char *, arith, int);
void CC_bhilb(int, arith, label, int);
void CC_bhpnam(int, arith, char *, int);
void CC_bhucon(int, arith, char *, arith, int);
void CC_crcst(int, arith);
void CC_crdlb(int, label, arith);
void CC_crdnam(int, char *, arith);
void CC_crilb(int, label);
void CC_crpnam(int, char *);
void CC_crscon(int, char *, arith);
void CC_crxcon(int, int, char *, arith);
void CC_cst(arith);
void CC_dfdlb(label);
void CC_dfdnam(char *);
void CC_dfilb(label);
void CC_dlb(label, arith);
void CC_dnam(char *, arith);
void CC_end(arith);
void CC_endnarg(void);
void CC_exc(arith, arith);
void CC_fcon(char *, arith);
void CC_icon(char *, arith);
void CC_ilb(label);
void CC_msend(void);
void CC_msstart(int);
void CC_op(int);
...
void CC_opdnam(int, char *, arith);
void CC_opilb(int, label);
void CC_opnarg(int);
void CC_oppnam(int, char *);
void CC_pnam(char *);
void CC_pro(char *, arith);
void CC_pronarg(char *);
void CC_psdlb(int, label);
void CC_psdnam(int, char *);
void CC_pspnam(int, char *);
void CC_scon(char *, arith);
void CC_ucon(char *, arith);
