...
void
moveq(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
...
void
move(i32 mask, int size, opDescriptor * source, opDescriptor * dest, int *errorPtr)
{
...
*/
void
zeroOp(i32 mask, int size, opDescriptor *source, opDescriptor *dest,
	int *errorPtr)
{
	(void)source;
	(void)dest;
...
*/
void
oneOp(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2)
...
*/
void
arithReg(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2)
...
*/
void
arithAddr(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2)
...
*/
void
quickMath(i32 mask, int size, opDescriptor * source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
...
*/
void
immedInst(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	unsigned short type;
/*
...
void
movep(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (!pass2) {
		loc += 4;
		return;
...
void
moves(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (!pass2) {
		loc += 4;
...
*/
void
moveReg(i32 mask, int size, opDescriptor * source, opDescriptor * dest,
	int *errorPtr)
{
	if (pass2) {
		output(mask | effAddr(dest), WORD);
...
*/
void
staticBit(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
		output(mask | effAddr(dest), WORD);
		loc += 2;
...
*/
void
movec(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
...
*/
void
trap(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
...
*/
void
branch(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	char shortDisp;
	i32 disp;
...
*/
void
immedToCCR(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (!pass2) {
		loc += 4;
		return;
...
*/
void
immedWord(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (!pass2) {
		loc += 4;
		return;
...
*/
void
dbcc(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	i32 disp;
...
*/
void
scc(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2)
		output(mask | effAddr(source), WORD);
	loc += 2;
...
*/
void
shiftReg(i32 mask, int size, opDescriptor * source, opDescriptor * dest, int *errorPtr)
{
	if (pass2) {
		mask |= dest->reg;
		if (source->mode == Immediate) {
...
void
exg(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
...
*/
void
twoReg(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
		output(mask | (dest->reg << 9) | source->reg, WORD);
	}
...
*/
void
oneReg(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
		output(mask | source->reg, WORD);
	}
...
*/
void
moveUSP(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (pass2) {
		if (source->mode == AnDirect)
			output(mask | source->reg, WORD);
...
void
link(i32 mask, int size, opDescriptor *source, opDescriptor *dest, int *errorPtr)
{
	if (!pass2) {
		loc += 4;
		return;
