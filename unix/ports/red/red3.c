...
MESS  ("cut    <block> <n>	Move lines in <block> after line <n>");
...
int
srch2 (char *old_pat, char *new_pat, int r_flag, int c_flag, int *a_flag, int s_anchor, int e_anchor, int plen)
{
...
int
get3args (char *args, int *val1, int def1, int *val2, int def2, int *val3, int def3)
{
